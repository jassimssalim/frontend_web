...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-xl w-80 sm:w-96 md:w-1/3 text-center transform transition-all duration-300 ease-in-out scale-95 hover:scale-100">
        <p className="text-lg text-gray-700 mb-6 font-semibold">{message}</p>
